...
export function HeroSection({ content }: { content: Content["hero"] }) {
  return (
    <header id="top" className="relative h-svh w-full overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute bottom-[clamp(1rem,3vw,2rem)] left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-2 text-[0.6rem] uppercase tracking-[0.4em] text-dim">
